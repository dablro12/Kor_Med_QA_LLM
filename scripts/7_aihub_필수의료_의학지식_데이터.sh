...
echo -e "${BOLD}${BLUE}✨ aihub_필수의료_의학지식_데이터 Benchmark 시작합니다 ✨${RESET}"
echo

TOTAL_START_TS=$(date +%s)

SAVE_ROOT="$WORKSPACE/kor_med_opendataset/results/aihub_필수의료_의학지식_데이터_benchmark/객관식"
DATA_PATH="$WORKSPACE/kor_med_opendataset/aihub_필수의료_의학지식_데이터/라벨링데이터_객관식.csv"
