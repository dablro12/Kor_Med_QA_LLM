...
- **Multiple Medical QA Datasets**
  - SNUH ClinicalQA
  - KorMedMCQA (sean0042)
  - AIHub Professional Medical Knowledge Dataset
  - AIHub Essential Medical Knowledge Dataset

- **Comprehensive LLM Model Support**
  - Qwen series
...
- **Automated Benchmark Execution**
  ...
  - OOM (Out of Memory) handling and retry logic
  - Automatic result saving and summarization
